//Wap in Flutter To Design Utensils Page
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Center(child: Image.asset('assets/images/cook.webp')),
            SizedBox(
              height: 20,
            ),
            Padding(
              padding: const EdgeInsetsDirectional.only(start: 10),
              child: Text('Utensils',style: TextStyle(
                  fontSize: 24,
            ...
            Padding(
              padding: const EdgeInsetsDirectional.only(start: 10),
              child: Text('Rexona Stainless Steel CookWare mughali Handi Zooni (Set of 3)',style: TextStyle(
                fontSize: 18,
              ),),
            ),
            SizedBox(
